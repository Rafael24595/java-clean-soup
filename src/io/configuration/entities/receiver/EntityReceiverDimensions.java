...
class EntityReceiverDimensions extends AbstractEntityReceiver implements IDimensionsReceiver {

    static final String DIMENSIONS_RECEIVER = "dimensions_receiver";
    static final String QUANTITY = "quantity";

    EntityReceiverDimensions() {
        super();
    }
    ...
    @Override
    public EntityReceiverDimensions build(Element element){
        super.build(element);
